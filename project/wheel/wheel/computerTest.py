...
def play_and_add(picker, guesser, d, verbose):
    ...
    board =  game.play(verbose)
    add_board_result_to_d(board, d)
    # END
...
def computer_plays(a, b, verbose=False):
    ...
    for i in range(a, b):
        ...
        picker.pick_word = lambda : picker.possible_words[i]
        ...
        # BEGIN
        "*** YOUR CODE HERE ***"
        guesser1 = ComputerPlayer(name="AI thing", skill=1)
        play_and_add(picker, guesser1, g1, verbose)

        guesser2 = ComputerPlayer(name="AI thing", skill=2)
...
if __name__ == "__main__":
    ...
    computer_plays(0, len(picker.possible_words))
