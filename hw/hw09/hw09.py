...
class Arr88():
    ...
    def __add__(self, arr88):
        ...
        "*** YOUR CODE HERE ***"
        tmp = []
        for idx in range(len(arr88)):
            tmp.append(self._values[idx] + arr88.item(idx))
        return Arr88(tmp)
    ...
    def negate(self):
        ...
        for idx in range(len(self)):
            self._values[idx] = - self.item(idx)
...
class VendingMachine:
    ...
    def restock(self, num):
        self.stock += num
        return 'Current candy stock: ' + str(num)
